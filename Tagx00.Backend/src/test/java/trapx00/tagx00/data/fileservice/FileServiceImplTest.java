...
public class FileServiceImplTest {
    ...
    public void findImageResultById() {
        ImageResult imageResult = fileService.findOne("1", ImageResult.class);
        System.out.println(((ImageWholeJob) imageResult.getImageJob()).getTuple().getDescriptions().get(0));
    }
