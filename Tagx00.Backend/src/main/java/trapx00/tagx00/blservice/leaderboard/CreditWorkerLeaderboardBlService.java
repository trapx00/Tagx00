...
public interface CreditWorkerLeaderboardBlService {
     ...
     */
    CreditWorkerLeaderboardResponse creditLeaderboard (PagingQueryVo pagingQueryVo);
     ...
     */
    CreditSpecificWorkerLeaderboardResponse specificWorker(String workerUsername);
}
