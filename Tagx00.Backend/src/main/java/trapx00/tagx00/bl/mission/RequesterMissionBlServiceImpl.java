        ...
        switch (missionCreateVo.getProperties().getType()) {
            case IMAGE:
                return new ImageMission("", missionCreateVo.getTitle(), missionCreateVo.getDescription(),
                        ...
                        ((ImageMissionProperties) missionCreateVo.getProperties()).isAllowCustomTag(), new ArrayList<>(((ImageMissionProperties) missionCreateVo.getProperties()).getAllowedTags().keySet()),
                        new ArrayList<>(),
