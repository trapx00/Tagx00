...
public class AudioJobAdapter implements JsonDeserializer<AudioJob>, JsonSerializer<AudioJob> {
     ...
     */
    @Override
    public AudioJob deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        return GsonFactory.get().fromJson(json,
            AudioMissionType.valueOf(
     ...
     */
    @Override
    public JsonElement serialize(AudioJob src, Type typeOfSrc, JsonSerializationContext context) {
