...
public class ThreeDimensionJobAdapter implements JsonDeserializer<ThreeDimensionJob>, JsonSerializer<ThreeDimensionJob> {
     ...
     */
    @Override
    public ThreeDimensionJob deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        return GsonFactory.get().fromJson(json,
            ThreeDimensionMissionType.valueOf(
     ...
     */
    @Override
    public JsonElement serialize(ThreeDimensionJob src, Type typeOfSrc, JsonSerializationContext context) {
