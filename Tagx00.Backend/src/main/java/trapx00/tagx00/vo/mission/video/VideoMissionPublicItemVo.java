...
public class VideoMissionPublicItemVo extends MissionPublicItemVo {
    ...
    public VideoMissionPublicItemVo(String missionId, String title, String description,
                                    List<String> topics, MissionType missionType, Date start,
                                    Date end, String coverUrl, int level, int credits,
